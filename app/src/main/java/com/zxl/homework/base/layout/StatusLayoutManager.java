...
public class StatusLayoutManager {
    ...
    public StatusLayoutManager(Builder builder) {
        ...
        this.loadingVs = builder.loadingVs;
    ...
    public static final class Builder {
        ...
        public Builder loadingView(@LayoutRes int loadingLayoutResId) {
            loadingVs = new ViewStub(context);
            loadingVs.setLayoutResource(loadingLayoutResId);
            return this;
        }
        ...
        public Builder loadingLayoutResId(int loadingLayoutResId) {
